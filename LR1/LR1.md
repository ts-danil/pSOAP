...
## Оценка результата:  
Благодаря перечисленным ресурсам, удалось найти обширную информацию по каждой из компаний. Я доволен результатом.  
    
## Вывод:  
Во время выполнения лабораторной работы получилось освежить в памяти пройденные способы поиска информации, а также удалось познакомиться с новыми инструментами для работы. 
